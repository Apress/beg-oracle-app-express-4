...
prompt  WEBSHEET APPLICATION 103 - Grizzlies Soccer
--
-- Websheet Application Export:
--   Application:     103
--   Name:            Grizzlies Soccer
--   Date and Time:   17:54 Sunday December 5, 2010
--   Exported By:     GIFFY
--   Export Type:     Websheet Application Export
--   Version:         4.0.2.00.06
--   Websheet Schema: BEGINNINGAPEX4

 
-- Import:
--   Using application builder
--   or
--   Using SQL*Plus as the Oracle user Websheet schema, BEGINNINGAPEX4.
...
begin
  ...
  -- Assumes you are running the script connected to SQL*Plus as the Websheet schema, BEGINNINGAPEX4.
  wwv_flow_api.set_security_group_id(p_security_group_id=>nvl(wwv_flow_application_install.get_workspace_id,1474005082929323));
...
begin
   ...
   -- SET APPLICATION ID
   wwv_flow.g_ws_app_id := nvl(wwv_flow_application_install.get_application_id,103);
...
wwv_flow_api.remove_ws_app(nvl(wwv_flow_application_install.get_application_id,103));
-- remove websheet metadata
wwv_flow_ws_import_api.remove_ws_components(nvl(wwv_flow_application_install.get_application_id,103));
...
wwv_flow_api.create_ws_app(
  ...
  p_language => 'en',
  p_territory => 'AMERICA',
  p_home_page_id => 1475600798029294+wwv_flow_api.g_id_offset,
  p_auth_id => 1475907490239421+wwv_flow_api.g_id_offset,
  p_acl_type => 'CUSTOM',
  p_login_url => '',
  p_logout_url => '',
  p_allow_sql_yn => 'Y',
  ...
  p_logo_text_attributes => 'style="font-family:Arial; color:#303030; font-size:22px; white-space:nowrap; font-weight:bold;"',
  p_varchar2_table => wwv_flow_api.g_varchar2_table,
  p_logo_filepath_attributes => '');
...
wwv_flow_ws_import_api.create_acl (
  p_id => 200012133805639898717699134255035057161+wwv_flow_api.g_id_offset,
...
begin
wwv_flow_ws_import_api.create_acl (
  p_id => 200017528378688715420185155826859639819+wwv_flow_api.g_id_offset,
  p_ws_app_id => wwv_flow.g_ws_app_id,
  p_username => 'MARTIN',
  p_priv => 'A'
  );
...
begin
wwv_flow_ws_import_api.create_acl (
  p_id => 200017528378694760049283228972733170699+wwv_flow_api.g_id_offset,
  p_ws_app_id => wwv_flow.g_ws_app_id,
  p_username => 'CAMERON',
  p_priv => 'R'
  );
...
wwv_flow_api.create_ws_auth_setup(
  p_id => 1475907490239421+wwv_flow_api.g_id_offset,
  p_websheet_application_id => wwv_flow.g_ws_app_id,
  p_name => 'Custom Authentication',
  p_invalid_session_url => 'f?p=4900:101:&SESSION.::NO::WS_APP_ID:&WS_APP_ID.&p_lang=&APP_SESSION_LANG.&p_territory=&APP_SESSION_TERRITORY.',
  p_auth_function => af,
  p_ldap_use_ssl => 'N',
  p_ldap_use_exact_dn => 'Y',
  p_logout_url => 'wwv_flow_custom_auth_std.ws_logout?p_websheet_app_id=&WS_APP_ID.&p_next_url=ws?p=103:14757'||wwv_flow.g_ws_app_id||':home'
  );
...
wwv_flow_api.create_ws_worksheet (
  p_id => 1480913383757374+wwv_flow_api.g_id_offset,
  p_flow_id => 4900,
  p_page_id => 2,
  p_region_id => null,
  p_name => 'Schedule',
...
wwv_flow_api.create_ws_data_grid (
    p_id => 1481019679757374+wwv_flow_api.g_id_offset,
    p_ws_app_id => wwv_flow.g_ws_app_id,
    p_worksheet_id => 1480913383757374+wwv_flow_api.g_id_offset,
    p_ws_report_owner => '',
    p_is_template => '',
    p_status => 'PRIVATE',
...
wwv_flow_api.create_ws_column ( 
  p_id => 1481130813757430+wwv_flow_api.g_id_offset,
  p_flow_id => 4900,
  p_page_id => null,
  p_worksheet_id => 1480913383757374+wwv_flow_api.g_id_offset,
  p_websheet_id => 1481019679757374+wwv_flow_api.g_id_offset,
...
begin
wwv_flow_api.create_ws_column ( 
  p_id => 1481214502757460+wwv_flow_api.g_id_offset,
  p_flow_id => 4900,
  p_page_id => null,
  p_worksheet_id => 1480913383757374+wwv_flow_api.g_id_offset,
  p_websheet_id => 1481019679757374+wwv_flow_api.g_id_offset,
...
begin
wwv_flow_api.create_ws_column ( 
  p_id => 1481302366757461+wwv_flow_api.g_id_offset,
  p_flow_id => 4900,
  p_page_id => null,
  p_worksheet_id => 1480913383757374+wwv_flow_api.g_id_offset,
  p_websheet_id => 1481019679757374+wwv_flow_api.g_id_offset,
...
begin
wwv_flow_api.create_ws_column ( 
  p_id => 1481415801757461+wwv_flow_api.g_id_offset,
  p_flow_id => 4900,
  p_page_id => null,
  p_worksheet_id => 1480913383757374+wwv_flow_api.g_id_offset,
  p_websheet_id => 1481019679757374+wwv_flow_api.g_id_offset,
...
begin
wwv_flow_api.create_ws_column ( 
  p_id => 1481509737757461+wwv_flow_api.g_id_offset,
  p_flow_id => 4900,
  p_page_id => null,
  p_worksheet_id => 1480913383757374+wwv_flow_api.g_id_offset,
  p_websheet_id => 1481019679757374+wwv_flow_api.g_id_offset,
...
begin
wwv_flow_api.create_ws_column ( 
  p_id => 1481608301757462+wwv_flow_api.g_id_offset,
  p_flow_id => 4900,
  p_page_id => null,
  p_worksheet_id => 1480913383757374+wwv_flow_api.g_id_offset,
  p_websheet_id => 1481019679757374+wwv_flow_api.g_id_offset,
...
begin
wwv_flow_api.create_ws_column ( 
  p_id => 1481706255757462+wwv_flow_api.g_id_offset,
  p_flow_id => 4900,
  p_page_id => null,
  p_worksheet_id => 1480913383757374+wwv_flow_api.g_id_offset,
  p_websheet_id => 1481019679757374+wwv_flow_api.g_id_offset,
...
wwv_flow_api.create_ws_rpt(
  p_id => 1489013007580360+wwv_flow_api.g_id_offset,
  p_flow_id=> 4900,
  p_page_id=> 2,
  p_worksheet_id => 1480913383757374+wwv_flow_api.g_id_offset,
  p_websheet_id  => 1481019679757374+wwv_flow_api.g_id_offset,
...
wwv_flow_api.create_ws_condition(
  p_id => 1489327014580361+wwv_flow_api.g_id_offset,
  p_flow_id=> 4900,
  p_page_id=> 2,
  p_worksheet_id => 1480913383757374+wwv_flow_api.g_id_offset,
  p_websheet_id => 1481019679757374+wwv_flow_api.g_id_offset,
  p_report_id => 1489013007580360+wwv_flow_api.g_id_offset,
  p_name =>'Row Filter',
  p_condition_type =>'FILTER',
  p_allow_delete =>'Y',
  p_expr_type =>'ROW',
  p_expr =>'B >= to_date(''10-jun-2010'', ''dd-mon-yyyy'')',
  p_condition_sql =>'"D001" >= to_date(''10-jun-2010'', ''dd-mon-yyyy'')',
  p_enabled =>'Y',
  p_column_format =>''
  );
end;
...
begin
wwv_flow_api.create_ws_condition(
  p_id => 1489214052580361+wwv_flow_api.g_id_offset,
  p_flow_id=> 4900,
  p_page_id=> 2,
  p_worksheet_id => 1480913383757374+wwv_flow_api.g_id_offset,
  p_websheet_id => 1481019679757374+wwv_flow_api.g_id_offset,
...
wwv_flow_api.create_ws_rpt(
  p_id => 1485720420317541+wwv_flow_api.g_id_offset,
  p_flow_id=> 4900,
  p_page_id=> 2,
  p_worksheet_id => 1480913383757374+wwv_flow_api.g_id_offset,
  p_websheet_id  => 1481019679757374+wwv_flow_api.g_id_offset,
...
begin
wwv_flow_api.create_ws_condition(
  p_id => 1485923751317544+wwv_flow_api.g_id_offset,
  p_flow_id=> 4900,
  p_page_id=> 2,
  p_worksheet_id => 1480913383757374+wwv_flow_api.g_id_offset,
  p_websheet_id => 1481019679757374+wwv_flow_api.g_id_offset,
  p_report_id => 1485720420317541+wwv_flow_api.g_id_offset,
  p_name =>'Next Two Weeks',
  p_condition_type =>'FILTER',
  p_allow_delete =>'Y',
  p_expr_type =>'ROW',
  p_expr =>'B >= to_date(''10-jun-2010'', ''dd-mon-yyyy'') and B < to_date(''10-jun-2010'', ''dd-mon-yyyy'') + 14',
...
wwv_flow_api.create_ws_rpt(
  p_id => 1481814768757708+wwv_flow_api.g_id_offset,
  p_flow_id=> 4900,
  p_page_id=> 2,
  p_worksheet_id => 1480913383757374+wwv_flow_api.g_id_offset,
  p_websheet_id  => 1481019679757374+wwv_flow_api.g_id_offset,
...
wwv_flow_api.create_ws_rpt(
  p_id => 1488302618577335+wwv_flow_api.g_id_offset,
  p_flow_id=> 4900,
  p_page_id=> 2,
  p_worksheet_id => 1480913383757374+wwv_flow_api.g_id_offset,
  p_websheet_id  => 1481019679757374+wwv_flow_api.g_id_offset,
...
begin
wwv_flow_api.create_ws_condition(
  p_id => 1488629137577338+wwv_flow_api.g_id_offset,
  p_flow_id=> 4900,
  p_page_id=> 2,
  p_worksheet_id => 1480913383757374+wwv_flow_api.g_id_offset,
  p_websheet_id => 1481019679757374+wwv_flow_api.g_id_offset,
  p_report_id => 1488302618577335+wwv_flow_api.g_id_offset,
  p_name =>'Row Filter',
  p_condition_type =>'FILTER',
  p_allow_delete =>'Y',
  p_expr_type =>'ROW',
...
begin
wwv_flow_api.create_ws_condition(
  p_id => 1488520522577337+wwv_flow_api.g_id_offset,
  p_flow_id=> 4900,
  p_page_id=> 2,
  p_worksheet_id => 1480913383757374+wwv_flow_api.g_id_offset,
  p_websheet_id => 1481019679757374+wwv_flow_api.g_id_offset,
...
declare
    rc1 varchar2(32767) := null;
begin
rc1:=rc1||'D001:C002:C003:C004:N001:N002';

wwv_flow_api.create_ws_rpt(
  p_id => 1489906559587915+wwv_flow_api.g_id_offset,
  p_flow_id=> 4900,
  p_page_id=> 2,
  p_worksheet_id => 1480913383757374+wwv_flow_api.g_id_offset,
  p_websheet_id  => 1481019679757374+wwv_flow_api.g_id_offset,
...
begin
wwv_flow_api.create_ws_condition(
  p_id => 1490232556587916+wwv_flow_api.g_id_offset,
  p_flow_id=> 4900,
  p_page_id=> 2,
  p_worksheet_id => 1480913383757374+wwv_flow_api.g_id_offset,
  p_websheet_id => 1481019679757374+wwv_flow_api.g_id_offset,
  p_report_id => 1489906559587915+wwv_flow_api.g_id_offset,
  p_condition_type =>'FILTER',
  p_allow_delete =>'Y',
  p_column_name =>'N001',
  p_operator =>'is not null',
  p_condition_sql =>'"N001" is not null',
...
begin
wwv_flow_api.create_ws_condition(
  p_id => 1490130430587915+wwv_flow_api.g_id_offset,
  p_flow_id=> 4900,
  p_page_id=> 2,
  p_worksheet_id => 1480913383757374+wwv_flow_api.g_id_offset,
  p_websheet_id => 1481019679757374+wwv_flow_api.g_id_offset,
...
wwv_flow_ws_import_api.create_row (
  p_id => 200040240659221702442364644365426492421+wwv_flow_api.g_id_offset,
  p_ws_app_id => wwv_flow.g_ws_app_id,
  p_data_grid_id => 1481019679757374+wwv_flow_api.g_id_offset,
  p_unique_value => '',
  p_owner => 'MARTIN',
  p_load_order => 200040240659222911368184258994601198597,
  p_c001 => 'Practice',
  p_c002 => '18:45',
  p_c003 => 'Bottomlands',
...
wwv_flow_ws_import_api.create_row (
  p_id => 200040240659224120294003873623775904773+wwv_flow_api.g_id_offset,
  p_ws_app_id => wwv_flow.g_ws_app_id,
  p_data_grid_id => 1481019679757374+wwv_flow_api.g_id_offset,
  p_unique_value => '',
  p_owner => 'MARTIN',
  p_load_order => 200040240659225329219823488252950610949,
  p_c001 => 'Practice',
  p_c002 => '19:00',
  p_c003 => 'Bottomlands',
...
wwv_flow_ws_import_api.create_row (
  p_id => 200040240659226538145643102882125317125+wwv_flow_api.g_id_offset,
  p_ws_app_id => wwv_flow.g_ws_app_id,
  p_data_grid_id => 1481019679757374+wwv_flow_api.g_id_offset,
  p_unique_value => '',
  p_owner => 'MARTIN',
  p_load_order => 200040240659227747071462717511300023301,
  p_c001 => 'Practice',
  p_c002 => '10:00',
  p_c003 => 'Forrest Lawn',
...
wwv_flow_ws_import_api.create_row (
  p_id => 200040240659228955997282332140474729477+wwv_flow_api.g_id_offset,
  p_ws_app_id => wwv_flow.g_ws_app_id,
  p_data_grid_id => 1481019679757374+wwv_flow_api.g_id_offset,
  p_unique_value => '',
  p_owner => 'MARTIN',
  p_load_order => 200040240659230164923101946769649435653,
  p_c001 => 'Game',
  p_c002 => '20:15',
  p_c003 => 'Airdrie',
  p_c004 => 'Airdrie',
...
wwv_flow_ws_import_api.create_row (
  p_id => 200040240659231373848921561398824141829+wwv_flow_api.g_id_offset,
  p_ws_app_id => wwv_flow.g_ws_app_id,
  p_data_grid_id => 1481019679757374+wwv_flow_api.g_id_offset,
  p_unique_value => '',
  p_owner => 'MARTIN',
  p_load_order => 200040240659232582774741176027998848005,
  p_c001 => 'Game',
  p_c002 => '20:15',
  p_c003 => 'Tom Brooks',
  p_c004 => 'Chinooks',
...
wwv_flow_ws_import_api.create_row (
  p_id => 200040240659233791700560790657173554181+wwv_flow_api.g_id_offset,
  p_ws_app_id => wwv_flow.g_ws_app_id,
  p_data_grid_id => 1481019679757374+wwv_flow_api.g_id_offset,
  p_unique_value => '',
  p_owner => 'MARTIN',
  p_load_order => 200040240659235000626380405286348260357,
  p_c001 => 'Practice',
  p_c002 => '21:00',
  p_c003 => 'Bottomlands',
...
wwv_flow_ws_import_api.create_row (
  p_id => 200040240659236209552200019915522966533+wwv_flow_api.g_id_offset,
  p_ws_app_id => wwv_flow.g_ws_app_id,
  p_data_grid_id => 1481019679757374+wwv_flow_api.g_id_offset,
  p_unique_value => '',
  p_owner => 'MARTIN',
  p_load_order => 200040240659237418478019634544697672709,
  p_c001 => 'Game',
  p_c002 => '19:00',
  p_c003 => 'Bottomlands',
  p_c004 => 'Blizzard',
...
wwv_flow_ws_import_api.create_row (
  p_id => 200040240659238627403839249173872378885+wwv_flow_api.g_id_offset,
  p_ws_app_id => wwv_flow.g_ws_app_id,
  p_data_grid_id => 1481019679757374+wwv_flow_api.g_id_offset,
  p_unique_value => '',
  p_owner => 'MARTIN',
  p_load_order => 200040240659239836329658863803047085061,
  p_c001 => 'Game',
  p_c002 => '13:00',
  p_c003 => 'Foothills',
  p_c004 => 'Callies',
...
wwv_flow_ws_import_api.create_row (
  p_id => 200040240659241045255478478432221791237+wwv_flow_api.g_id_offset,
  p_ws_app_id => wwv_flow.g_ws_app_id,
  p_data_grid_id => 1481019679757374+wwv_flow_api.g_id_offset,
  p_unique_value => '',
  p_owner => 'MARTIN',
  p_load_order => 200040240659242254181298093061396497413,
  p_c001 => 'Practice',
  p_c002 => '18:45',
  p_c003 => 'Bottomlands',
...
wwv_flow_ws_import_api.create_row (
  p_id => 200040240659243463107117707690571203589+wwv_flow_api.g_id_offset,
  p_ws_app_id => wwv_flow.g_ws_app_id,
  p_data_grid_id => 1481019679757374+wwv_flow_api.g_id_offset,
  p_unique_value => '',
  p_owner => 'MARTIN',
  p_load_order => 200040240659244672032937322319745909765,
  p_c001 => 'Game',
  p_c002 => '19:15',
  p_c003 => 'Bottomlands',
  p_c004 => 'Darts',
...
wwv_flow_ws_import_api.create_row (
  p_id => 200040240659245880958756936948920615941+wwv_flow_api.g_id_offset,
  p_ws_app_id => wwv_flow.g_ws_app_id,
  p_data_grid_id => 1481019679757374+wwv_flow_api.g_id_offset,
  p_unique_value => '',
  p_owner => 'MARTIN',
  p_load_order => 200040240659247089884576551578095322117,
  p_c001 => 'Game',
  p_c002 => '18:45',
  p_c003 => 'Glenmore',
  p_c004 => 'Vipers',
...
wwv_flow_ws_import_api.create_row (
  p_id => 200040240659248298810396166207270028293+wwv_flow_api.g_id_offset,
  p_ws_app_id => wwv_flow.g_ws_app_id,
  p_data_grid_id => 1481019679757374+wwv_flow_api.g_id_offset,
  p_unique_value => '',
  p_owner => 'MARTIN',
  p_load_order => 200040240659249507736215780836444734469,
  p_c001 => 'Game',
  p_c002 => '15:30',
  p_c003 => 'Mount Royal',
  p_c004 => 'Darts',
...
wwv_flow_ws_import_api.create_row (
  p_id => 200040240659250716662035395465619440645+wwv_flow_api.g_id_offset,
  p_ws_app_id => wwv_flow.g_ws_app_id,
  p_data_grid_id => 1481019679757374+wwv_flow_api.g_id_offset,
  p_unique_value => '',
  p_owner => 'MARTIN',
  p_load_order => 200040240659251925587855010094794146821,
  p_c001 => 'Game',
  p_c002 => '19:00',
  p_c003 => 'Bottomlands',
  p_c004 => 'Wolves',
...
wwv_flow_ws_import_api.create_row (
  p_id => 200040240659253134513674624723968852997+wwv_flow_api.g_id_offset,
  p_ws_app_id => wwv_flow.g_ws_app_id,
  p_data_grid_id => 1481019679757374+wwv_flow_api.g_id_offset,
  p_unique_value => '',
  p_owner => 'MARTIN',
  p_load_order => 200040240659254343439494239353143559173,
  p_c001 => 'Practice',
  p_c002 => '11:00',
  p_c003 => 'Bottomlands',
...
wwv_flow_ws_import_api.create_row (
  p_id => 200040240659255552365313853982318265349+wwv_flow_api.g_id_offset,
  p_ws_app_id => wwv_flow.g_ws_app_id,
  p_data_grid_id => 1481019679757374+wwv_flow_api.g_id_offset,
  p_unique_value => '',
  p_owner => 'MARTIN',
  p_load_order => 200040240659256761291133468611492971525,
  p_c001 => 'Game',
  p_c002 => '20:00',
  p_c003 => 'Oakridge',
  p_c004 => 'ASP',
...
wwv_flow_ws_import_api.create_row (
  p_id => 200040240659257970216953083240667677701+wwv_flow_api.g_id_offset,
  p_ws_app_id => wwv_flow.g_ws_app_id,
  p_data_grid_id => 1481019679757374+wwv_flow_api.g_id_offset,
  p_unique_value => '',
  p_owner => 'MARTIN',
  p_load_order => 200040240659259179142772697869842383877,
  p_c001 => 'Game',
  p_c002 => '21:00',
  p_c003 => 'Tom Brooks',
  p_c004 => 'Storm',
...
wwv_flow_ws_import_api.create_row (
  p_id => 200040240659260388068592312499017090053+wwv_flow_api.g_id_offset,
  p_ws_app_id => wwv_flow.g_ws_app_id,
  p_data_grid_id => 1481019679757374+wwv_flow_api.g_id_offset,
  p_unique_value => '',
  p_owner => 'MARTIN',
  p_load_order => 200040240659261596994411927128191796229,
  p_c001 => 'Practice',
  p_c002 => '19:15',
  p_c003 => 'Bottomlands',
...
wwv_flow_ws_import_api.create_row (
  p_id => 200040240659262805920231541757366502405+wwv_flow_api.g_id_offset,
  p_ws_app_id => wwv_flow.g_ws_app_id,
  p_data_grid_id => 1481019679757374+wwv_flow_api.g_id_offset,
  p_unique_value => '',
  p_owner => 'MARTIN',
  p_load_order => 200040240659264014846051156386541208581,
  p_c001 => 'Game',
  p_c002 => '19:15',
  p_c003 => 'Bottomlands',
  p_c004 => 'Tigers',
...
q := null;
wwv_flow_api.create_ws_worksheet (
  p_id => 1483905310931138+wwv_flow_api.g_id_offset,
  p_flow_id => 4900,
  p_page_id => 2,
  p_region_id => null,
  p_name => 'Players',
...
begin
wwv_flow_api.create_ws_data_grid (
    p_id => 1484017001931138+wwv_flow_api.g_id_offset,
    p_ws_app_id => wwv_flow.g_ws_app_id,
    p_worksheet_id => 1483905310931138+wwv_flow_api.g_id_offset,
    p_ws_report_owner => '',
    p_is_template => '',
    p_status => 'PRIVATE',
    p_websheet_type => 'DATA',
...
begin
wwv_flow_api.create_ws_column ( 
  p_id => 1484125828931168+wwv_flow_api.g_id_offset,
  p_flow_id => 4900,
  p_page_id => null,
  p_worksheet_id => 1483905310931138+wwv_flow_api.g_id_offset,
  p_websheet_id => 1484017001931138+wwv_flow_api.g_id_offset,
  p_db_column_name => 'C001',
  p_display_order => 10,
  p_data_grid_form_seq => 1,
  p_column_identifier => 'A',
...
begin
wwv_flow_api.create_ws_column ( 
  p_id => 1484215656931178+wwv_flow_api.g_id_offset,
  p_flow_id => 4900,
  p_page_id => null,
  p_worksheet_id => 1483905310931138+wwv_flow_api.g_id_offset,
  p_websheet_id => 1484017001931138+wwv_flow_api.g_id_offset,
...
wwv_flow_api.create_ws_rpt(
  p_id => 1484325784931238+wwv_flow_api.g_id_offset,
  p_flow_id=> 4900,
  p_page_id=> 2,
  p_worksheet_id => 1483905310931138+wwv_flow_api.g_id_offset,
  p_websheet_id  => 1484017001931138+wwv_flow_api.g_id_offset,
...
wwv_flow_ws_import_api.create_row (
  p_id => 200012133805633854088601061109161526281+wwv_flow_api.g_id_offset,
  p_ws_app_id => wwv_flow.g_ws_app_id,
  p_data_grid_id => 1484017001931138+wwv_flow_api.g_id_offset,
  p_unique_value => '',
  p_owner => 'MARTIN',
  p_load_order => 200012133805635063014420675738336232457,
  p_c001 => 'Chris',
  p_n001 => 1,
  p_search_clob => sc
  );
...
wwv_flow_ws_import_api.create_row (
  p_id => 200017528378689924346004770456034345995+wwv_flow_api.g_id_offset,
  p_ws_app_id => wwv_flow.g_ws_app_id,
  p_data_grid_id => 1484017001931138+wwv_flow_api.g_id_offset,
  p_unique_value => '',
  p_owner => 'MARTIN',
  p_load_order => 200017528378691133271824385085209052171,
  p_c001 => 'Cameron',
  p_n001 => 1,
  p_search_clob => sc
  );
...
wwv_flow_ws_import_api.create_row (
  p_id => 200040240659267641623510000274065327109+wwv_flow_api.g_id_offset,
  p_ws_app_id => wwv_flow.g_ws_app_id,
  p_data_grid_id => 1484017001931138+wwv_flow_api.g_id_offset,
  p_unique_value => '',
  p_owner => 'MARTIN',
  p_load_order => 200040240659268850549329614903240033285,
  p_c001 => 'Martin',
  p_n001 => 2,
  p_search_clob => sc
  );
...
--application/pages/page_1475600798029294
prompt  ...PAGE 1475600798029294: Home
--
begin
wwv_flow_api.create_ws_page (
    p_id => 1475600798029294+wwv_flow_api.g_id_offset,
    p_page_number => null,
    p_ws_app_id => wwv_flow.g_ws_app_id,
...
begin
c:=c||'<p>'||chr(10)||
'	Fees: Don&#39;t forget to pay your fees before the next &nbsp;game (13-Jun) or else you can&#39;t play!</p>'||chr(10)||
'<p>'||chr(10)||
'	We won our last game and are now 2-1. Check out the&nbsp;<span class="Apple-style-span" style="font-family: monospace; white-space: pre; ">[[ results | Results ]] page.</span></p>'||chr(10)||
'';

wwv_flow_ws_import_api.create_section(
   p_id => 200012133805632645162781446479986820105+wwv_flow_api.g_id_offset,
   p_ws_app_id => wwv_flow.g_ws_app_id,
   p_webpage_id => 1475600798029294+wwv_flow_api.g_id_offset,
...
begin
wwv_flow_ws_import_api.create_section(
   p_id => 200017528378693551123463614343558464523+wwv_flow_api.g_id_offset,
   p_ws_app_id => wwv_flow.g_ws_app_id,
   p_webpage_id => 1475600798029294+wwv_flow_api.g_id_offset,
   ...
   p_title => 'Navigation',
   p_content_upper => upper(wwv_flow_utilities.striphtml(c)),
   p_nav_start_webpage_id => 1475600798029294+wwv_flow_api.g_id_offset,
   p_nav_max_level => 12,
...
begin
wwv_flow_ws_import_api.create_section(
   p_id => 200040240659270059475149229532414739461+wwv_flow_api.g_id_offset,
   p_ws_app_id => wwv_flow.g_ws_app_id,
   p_webpage_id => 1475600798029294+wwv_flow_api.g_id_offset,
...
begin
c:=c||'<p>'||chr(10)||
'	Martin scored 2 goals!</p>'||chr(10)||
'<p>'||chr(10)||
'	[[image: martin.jpg ]]</p>'||chr(10)||
'';

wwv_flow_ws_import_api.create_section(
   p_id => 200040240659271268400968844161589445637+wwv_flow_api.g_id_offset,
   p_ws_app_id => wwv_flow.g_ws_app_id,
   p_webpage_id => 1475600798029294+wwv_flow_api.g_id_offset,
...
--application/pages/page_1491300559728156
prompt  ...PAGE 1491300559728156: Players
--
begin
wwv_flow_api.create_ws_page (
    p_id => 1491300559728156+wwv_flow_api.g_id_offset,
    p_page_number => null,
    p_ws_app_id => wwv_flow.g_ws_app_id,
    p_parent_page_id => 1475600798029294+wwv_flow_api.g_id_offset,
    p_name => 'Players',
    p_upper_name => 'PLAYERS',
...
begin
wwv_flow_ws_import_api.create_section(
   p_id => 200012133805636271940240290367510938633+wwv_flow_api.g_id_offset,
   p_ws_app_id => wwv_flow.g_ws_app_id,
   p_webpage_id => 1491300559728156+wwv_flow_api.g_id_offset,
   p_display_sequence => 10,
   p_section_type => 'DATA',
   p_title => 'Players',
   p_data_grid_id => 1484017001931138+wwv_flow_api.g_id_offset,
   p_report_id => 1484325784931238+wwv_flow_api.g_id_offset,
   p_data_section_style => 2,
   p_chart_sorting => ''
   );
...
begin
wwv_flow_ws_import_api.create_section(
   p_id => 200012133805637480866059904996685644809+wwv_flow_api.g_id_offset,
   p_ws_app_id => wwv_flow.g_ws_app_id,
   p_webpage_id => 1491300559728156+wwv_flow_api.g_id_offset,
   p_display_sequence => 20,
...
begin
wwv_flow_ws_import_api.create_section(
   p_id => 200040240659273686252608073419938857989+wwv_flow_api.g_id_offset,
   p_ws_app_id => wwv_flow.g_ws_app_id,
   p_webpage_id => 1491300559728156+wwv_flow_api.g_id_offset,
   p_display_sequence => 1,
...
begin
c:=c||'<p>'||chr(10)||
'	We currently have [[sqlvalue: select count(*) from tusers where active_flag = &#39;Y&#39; ]] active registered users. They are: [[sql: select initcap(user_name) &quot;Name&quot; from tusers order by user_name ]]</p>'||chr(10)||
'';

wwv_flow_ws_import_api.create_section(
   p_id => 200050995884719773046056385269731427335+wwv_flow_api.g_id_offset,
   p_ws_app_id => wwv_flow.g_ws_app_id,
   p_webpage_id => 1491300559728156+wwv_flow_api.g_id_offset,
...
--application/pages/page_1492218239884589
prompt  ...PAGE 1492218239884589: Results
--
begin
wwv_flow_api.create_ws_page (
    p_id => 1492218239884589+wwv_flow_api.g_id_offset,
    p_page_number => null,
    p_ws_app_id => wwv_flow.g_ws_app_id,
    p_parent_page_id => 1475600798029294+wwv_flow_api.g_id_offset,
    p_name => 'Results',
...
begin
wwv_flow_ws_import_api.create_section(
   p_id => 200050995884718564120236770640556721159+wwv_flow_api.g_id_offset,
   p_ws_app_id => wwv_flow.g_ws_app_id,
   p_webpage_id => 1492218239884589+wwv_flow_api.g_id_offset,
   p_display_sequence => 10,
   p_section_type => 'DATA',
   p_title => 'Results',
   p_data_grid_id => 1481019679757374+wwv_flow_api.g_id_offset,
...
--application/pages/page_1492425989896329
prompt  ...PAGE 1492425989896329: Schedule
--
begin
wwv_flow_api.create_ws_page (
    p_id => 1492425989896329+wwv_flow_api.g_id_offset,
    p_page_number => null,
    p_ws_app_id => wwv_flow.g_ws_app_id,
    p_parent_page_id => 1475600798029294+wwv_flow_api.g_id_offset,
    p_name => 'Schedule',
...
begin
wwv_flow_ws_import_api.create_section(
   p_id => 200012133805638689791879519625860350985+wwv_flow_api.g_id_offset,
   p_ws_app_id => wwv_flow.g_ws_app_id,
   p_webpage_id => 1492425989896329+wwv_flow_api.g_id_offset,
   p_display_sequence => 10,
   p_section_type => 'DATA',
...
begin
wwv_flow_ws_import_api.create_section(
   p_id => 200017528378692342197643999714383758347+wwv_flow_api.g_id_offset,
   p_ws_app_id => wwv_flow.g_ws_app_id,
   p_webpage_id => 1492425989896329+wwv_flow_api.g_id_offset,
   p_display_sequence => 20,
   p_section_type => 'DATA',
...
wwv_flow_ws_import_api.create_file(
  p_id => 200050995884717355194417156011382014983+wwv_flow_api.g_id_offset,
  p_ws_app_id => wwv_flow.g_ws_app_id,
  p_webpage_id => 1475600798029294+wwv_flow_api.g_id_offset,
  p_component_level => 'WEBPAGE',
  p_name => 'martin.jpg',
  p_varchar2_table=> wwv_flow_api.g_varchar2_table,
  p_content_last_update =>to_date('20101203035837','YYYYMMDDHH24MISS'),
